                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-2 d-none d-xl-block">
                            <ul>
                                @foreach($categories->take(11) as $index => $category)
                                    <li>
                                        @if($index === $categories->take(11)->count() - 1)
                        ...
                        <div class="col pe-0">
                            <div class="home-banner p-right"> <img style="transform: rotateY(180deg)" class="img-fluid" src="https://cdn.shopify.com/s/files/1/1215/2782/files/leo_oobliss_slide3-h1.jpg?v=1601086934"
                                    alt="" />
                                <div class="contain-banner">
                                    <div>
                                        <h4>Ưu đãi <span>Từ hôm nay</span></h4>
                                        <h1>Giảm ngay 200k </h1>
                                        <p>cho đơn hàng từ 1,500,000 VND. </p>
                                        <div class="link-hover-anim underline"><a
                                                class="btn btn_underline link-strong link-strong-unhovered"
                                                href="collection-left-sidebar.html">Mua ngay<svg>
            ...
            <section class="section-t-space">
                <div class="custom-container container service">
                    <ul>
                        <li>
                            <div class="service-block">
                                <img src="{{asset('assets/images/svg-icon/1.svg')}}" alt="" />
                                <div>
                                    <h6>Giao Hàng Miễn Phí Toàn Cầu</h6>
                                    <p>Áp dụng cho tất cả đơn hàng trên 1 triêu đồng.</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="service-block">
                                <img src="{{asset('assets/images/svg-icon/2.svg')}}" alt="" />
                                <div>
                                    <h6>Đổi & Trả Hàng</h6>
                        ...
                        <li>
                            <div class="service-block">
                                <img src="{{asset('assets/images/svg-icon/3.svg')}}" alt="" />
                                <div>
                        ...
                        <li>
                            <div class="service-block border-0">
                                <img src="{{asset('assets/images/svg-icon/4.svg')}}" alt="" />
                                <div>
                                    <h6>Phiếu Quà Tặng Hàng Ngày</h6>
                                    <p>Giảm giá mua sắm thêm thú vị</p>
                                </div>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="row">
                            ...
                            <div class="row gy-4 ratio_45">
                                <div class="col-12">
                                    <div class="collection-banner p-left"> <img class="bg-img"
                                            src="{{asset('assets/images/banner/banner-7.jpg')}}" alt="" />
                                        <div class="contain-banner">
                                            <div>
                                                <h4>Giảm tới 30%</h4>
                                                <div class="link-hover-anim underline"><a
                                ...
                                <div class="col-12">
                                    <div class="collection-banner p-right"><img class="bg-img"
                                            src="{{asset('assets/images/banner/banner-8.jpg')}}" alt="" />
                                        <div class="contain-banner">
                                            <div>
                                                <h4>Giảm tới 40%</h4>
                        ...
                        <div class="col-xxl-3 col-4 d-none d-lg-block">
                            <div class="special-offer-slider">
                                ...
                                <div class="swiper special-offer-slide">
                                    <div class="swiper-wrapper trending-products">
                                        @foreach($categories[0]->products->take(2) as $product)  <!-- Hiển thị chỉ 2 sản phẩm -->
                                            <div class="swiper-slide product-box-3">
                                                <div class="img-wrapper">
                                                    ...
                                                    <div class="product-image ratio_apos">
                                                        <a class="pro-first" href="{{ url('/san-pham/' . $product->slug) }}">
                                                            <img class="bg-img" src="{{ Storage::url(is_array($product->images) ? $product->images[0] : $product->images) }}" alt="{{ $product->name }}" />
                                                        </a>
                                                        <a class="pro-sec" href="{{ url('/san-pham/' . $product->slug) }}">
                                                            <img class="bg-img" src="{{ Storage::url(is_array($product->images) ? $product->images[0] : $product->images) }}" alt="{{ $product->name }}" />
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="product-detail">
                                                    <ul class="rating">
                                                        @for ($i = 0; $i < 5; $i++)
                                                            <li><i class="fa{{ $i < $product->rating ? '-solid' : '-regular' }} fa-star"></i></li>
                                                        @endfor
                        ...
                        <div class="col-4 d-none d-xxl-block">
                            <div class="offer-banner-3 ratio1_3"> <a href="#"> <img class="bg-img"
                                        src="https://qx-glosion.myshopify.com/cdn/shop/files/banner-1.jpg?v=1709185934&width=1200" alt="" />
                                    <div> <img src="{{asset('assets/images/banner/2.png')}}" alt="" />
                                        <h6>SALE UP TO 70%</h6>
                                    </div>
                                </a></div>
                        </div>
                                                    ...
                                                    <div class="product-box-3">
                                                        <div class="img-wrapper">
                                                            ...
                                                            <div class="product-image">
                                                                <a class="pro-first" href="{{ url('/san-pham/' . $category->slug . '/' . $product->slug) }}">
                                                                    <img class="bg-img" src="{{ Storage::url(is_array($product->images) ? $product->images[0] : $product->images) }}" alt="{{ $product->name }}" />
                                                                </a>
                                                                <a class="pro-sec" href="{{ url('/san-pham/' . $category->slug . '/' . $product->slug) }}">
                                                                    <img class="bg-img" src="{{ Storage::url(is_array($product->images) ? $product->images[0] : $product->images) }}" alt="{{ $product->name }}" />
                                                                </a>
                                                            </div>
                                                            <div class="cart-info-icon">
                                                        ...
                                                        <div class="product-detail">
                                                            ...
                                                            <a href="{{ url('/san-pham/' . $category->slug . '/' . $product->slug) }}">
                                                                <h6>{{ $product->name }}</h6>
                                                            </a>
                                                            <p>{{ number_format($product->price, 0, ',', '.') }} VNĐ
                                                                @if($product->old_price)
                        ...
                        <div class="col-sm-3 col-6">
                            <div class="brand-logo-txt">
                                <div>
                                    ...
                                    <h4>Giảm tới 40%</h4>
                                    <div class="link-hover-anim underline"><a
                                            class="btn btn_underline link-strong link-strong-unhovered" href="{{ url('/') }}">Mua ngay<svg>
                                                <use href="../assets/svg/icon-sprite.svg#arrow"></use>
                                            </svg></a><a class="btn btn_underline link-strong link-strong-hovered"
                                            href="{{ url('/') }}"> Mua ngay<svg>
                                                <use href="../assets/svg/icon-sprite.svg#arrow"></use>
                                            </svg></a></div>
                                </div>
                            </div>
                    ...
                    <div class="swiper insta-slide-3">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="instagram-box-1">
                                    <div class="instagram-box">
                                        <div class="instashop-effect"><img src="{{asset('assets/images/instagram/6.jpg')}}" alt="" />
                                            <div class="insta-txt">
                            ...
                            <div class="swiper-slide">
                                <div class="instagram-box-1">
                                    <div class="instagram-box">
                                        <div class="instashop-effect"><img src="{{asset('assets/images/instagram/7.jpg')}}" alt="" />
                                            <div class="insta-txt">
                                                <div><svg class="insta-icon">
                                                        <use href="../assets/svg/icon-sprite.svg#instagram"></use>
                                                    </svg>
                            ...
                            <div class="swiper-slide">
                                <div class="instagram-box-1">
                                    <div class="instagram-box">
                                        <div class="instashop-effect"><img src="{{asset('assets/images/instagram/8.jpg')}}" alt="" />
                                            <div class="insta-txt">
                                                <div><svg class="insta-icon">
                                                        <use href="../assets/svg/icon-sprite.svg#instagram"></use>
                                                    </svg>
                            ...
                            <div class="swiper-slide">
                                <div class="instagram-box-1">
                                    <div class="instagram-box">
                                        <div class="instashop-effect"><img src="{{asset('assets/images/instagram/9.jpg')}}" alt="" />
                                            <div class="insta-txt">
                                                <div><svg class="insta-icon">
                                                        <use href="../assets/svg/icon-sprite.svg#instagram"></use>
                                                    </svg>
                            ...
                            <div class="swiper-slide">
                                <div class="instagram-box-1">
                                    <div class="instagram-box">
                                        <div class="instashop-effect"><img src="{{asset('assets/images/instagram/10.jpg')}}" alt="" />
                                            <div class="insta-txt">
                                                <div><svg class="insta-icon">
                                                        <use href="../assets/svg/icon-sprite.svg#instagram"></use>
                                                    </svg>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <div class="newslwtter-content"><img class="img-fluid"
                                                src="{{asset('assets/images/other-img/text.png')}}" alt="" />
                                    ...
                                    <div class="col-md-6 d-none d-lg-block">
                                        <div class="newslwtter-img"> <img class="img-fluid"
                                                src="{{asset('assets/images/other-img/news-latter.png')}}" alt="" /></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Skeleton Loader JS -->
<script src="{{ asset('assets/js/skeleton-loader.js') }}"></script>
